...
<table border="2" align="center" cellspacing="0" cellpadding="">
    ...
    <tr>
        ...
        <td><img align="middle" src="assets/img/Correlation_CMR_gene_length.png" alt="Correlation of CMR-related genes with gene length analysis" height="300px" width="300px" valign="middle"></td>
        <td><img align="middle" src="assets/img/Difference_CMR_gene_length.png" alt="Difference of CMR-related genes with gene length analysis" height="200px" width="200px" valign="middle"></td>
    </tr>
    <tr>
        <td>Exon length analysis</td>
        <td><img align="middle" src="assets/img/Correlation_CMR_exon_length.png" alt="Correlation of CMR-related genes with exon length analysis" height="300px" width="300px" valign="middle"></td>
        <td><img align="middle" src="assets/img/Difference_CMR_exon_length.png" alt="Difference of CMR-related genes with exon length analysis" height="200px" width="200px" valign="middle"></td>
    </tr>
    <tr>
        <td>Intron length analysis</td>
        <td><img align="middle" src="assets/img/Correlation_CMR_intron_length.png" alt="Correlation of CMR-related genes with intron length analysis" height="300px" width="300px" valign="middle"></td>
        <td><img align="middle" src="assets/img/Difference_CMR_intron_length.png" alt="Difference of CMR-related genes with intron length analysis" height="200px" width="200px" valign="middle"></td>
    </tr>
    <tr>
        <td>Exon number analysis</td>
        <td><img align="middle" src="assets/img/Correlation_CMR_exon_number.png" alt="Correlation of CMR-related genes with exon number analysis" height="300px" width="300px" valign="middle"></td>
        <td><img align="middle" src="assets/img/Difference_CMR_exon_number.png" alt="Difference of CMR-related genes with exon number analysis" height="200px" width="200px" valign="middle"></td>
    </tr>
    <tr>
        <td>GC content analysis</td>
        <td><img align="middle" src="assets/img/Correlation_CMR_GC_content.png" alt="Correlation of CMR-related genes with GC content analysis" height="300px" width="300px" valign="middle"></td>
        <td><img align="middle" src="assets/img/Difference_CMR_GC_content.png" alt="Difference of CMR-related genes with GC content analysis" height="200px" width="200px" valign="middle"></td>
    </tr>
</table>
</div>
