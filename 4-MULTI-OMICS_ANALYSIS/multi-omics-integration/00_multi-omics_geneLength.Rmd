...
```{r echo = FALSE, warning=FALSE, message=FALSE}
type1Stat <- boxplot.stats(type1Feature$geneLength)$stats
tmpType1 <- type1Feature$geneLength[which(type1Feature$geneLength <= type1Stat[5])]

type2Stat <- boxplot.stats(type2Feature$geneLength)$stats
tmpType2 <- type2Feature$geneLength[which(type2Feature$geneLength <= type2Stat[5])]
```

### The statistics of gene length difference between type 1 and type 2 genes
```{r echo = FALSE, warning = FALSE, message = FALSE}
...
### Gene length difference between type 1 and type 2 genes
```{r echo = FALSE, warning=FALSE, message=FALSE}
