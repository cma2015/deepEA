...
```{r echo = FALSE, warning=FALSE, message=FALSE}
type1Stat <- boxplot.stats(type1Feature$exonLength)$stats
tmpType1 <- type1Feature$exonLength[which(type1Feature$exonLength <= type1Stat[5])]

type2Stat <- boxplot.stats(type2Feature$exonLength)$stats
tmpType2 <- type2Feature$exonLength[which(type2Feature$exonLength <= type2Stat[5])]
```

### The statistics of exon length difference between type 1 and type2 genes
```{r echo = FALSE, warning = FALSE, message = FALSE}
...
### Exon length difference between type 1 and type 2 genes
```{r echo = FALSE, warning=FALSE, message=FALSE}
